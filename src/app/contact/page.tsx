    ...
    <PageShell>
      ...
      <div className="grid grid-cols-1 gap-16 py-12 md:grid-cols-[55fr_45fr]">
        ...
        <div className="md:pt-7">
          ...
          {/* Press & Media */}
          <div className="mt-6">
            <p className="font-heading text-xl font-bold text-brand-white">
              Press &amp; Media
            </p>
            <p className="mt-1 text-base text-brand-white">Carol Band</p>
            <p className="text-base text-brand-white">(617) 969 0334</p>
            <a
              href="mailto:carol@carolband.com"
              className="text-base text-brand-teal transition-colors hover:text-brand-teal-light"
            >
              carol@carolband.com
            </a>
          </div>
          ...
          <div className="mt-6">
            ...
            <a
              ...
              className="mt-1 block text-base text-brand-teal transition-colors hover:text-brand-teal-light"
            >
